...
- Upstream path: `plugins/expo/skills/expo-examples`
- Local skill path: `26-mobile-apple/expo-examples`
- License: MIT
...
- 2026-09-05 — updated to `d0075ffa0992`, the skill's first recorded baseline. Drops the two pointers to an `expo-tailwind-setup` skill that no longer exists upstream.
