...
if [ -d research-wiki/ ]; then
  ...
  [ -f "$WIKI_SCRIPT" ] || {
    echo "WARN: research_wiki.py not found; paper summary delivered, wiki ingest skipped. Fix: bash ../../tools/aris/install_aris.sh or smart_update.sh (refreshes ~/.aris/repo), export ARIS_REPO, or cp <ARIS-repo>/tools/research_wiki.py tools/." >&2
    WIKI_SCRIPT=""
  }
