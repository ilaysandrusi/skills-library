...
folded into a parenthesis during an em-dash conversion. The next sentence then
begins inside the same span and runs well past the intended appositive boundary)
which a balance check cannot detect.
