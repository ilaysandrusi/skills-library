...
- Upstream path: `plugins/documentation-standards/skills/hads`
- Local skill path: `06-documents/hads`
- License: MIT
...
`documentation-standards` plugin's `skills/` tree. Everything listed above lives inside that
