...
```bash
python "${CLAUDE_PLUGIN_ROOT}/../../scripts/digital-marketing-pro/team-manager.py" --brand {slug} --action check-capacity --data '{"task_type":"email-campaign","region":"europe","weight":4}'
```
