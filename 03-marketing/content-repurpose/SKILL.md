...
2. **Check campaign history**: Run `python "${CLAUDE_PLUGIN_ROOT}/../../scripts/digital-marketing-pro/campaign-tracker.py" --brand {slug} --action list-campaigns` to identify related campaigns and previously published content that derivative pieces can reference or link to.
