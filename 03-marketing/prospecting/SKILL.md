...
For implementation, see the [tools registry](../../tools/coreyhaines-marketing/REGISTRY.md). Key prospecting tools:

| Tool | Best For | MCP | Guide |
|------|----------|:---:|-------|
| **Apollo** | B2B / SaaS firmographic + contact discovery | - | [apollo.md](../../tools/coreyhaines-marketing/integrations/apollo.md) |
| **Clay** | Multi-source enrichment + waterfall | ✓ | [clay.md](../../tools/coreyhaines-marketing/integrations/clay.md) |
| **Clearbit** | Email-to-company enrichment | - | [clearbit.md](../../tools/coreyhaines-marketing/integrations/clearbit.md) |
| **ZoomInfo** | Enterprise B2B contact + intent | ✓ | [zoominfo.md](../../tools/coreyhaines-marketing/integrations/zoominfo.md) |
| **Hunter** | Email pattern + verification | - | [hunter.md](../../tools/coreyhaines-marketing/integrations/hunter.md) |
| **Snov** | Email finder + verifier | - | [snov.md](../../tools/coreyhaines-marketing/integrations/snov.md) |
| **Truelist** | Email deliverability validation | - | [truelist.md](../../tools/coreyhaines-marketing/integrations/truelist.md) |
| **Outreach** | Sales engagement (post-list) | ✓ | [outreach.md](../../tools/coreyhaines-marketing/integrations/outreach.md) |
| **RB2B** | Visitor identification (warm intent) | - | [rb2b.md](../../tools/coreyhaines-marketing/integrations/rb2b.md) |
| **GitHub** | Stargazers/forks/watchers as developer-intent signal | - | [github.md](../../tools/coreyhaines-marketing/integrations/github.md) |
| **Firecrawl** | Single-target site extraction (prospect's own website) | ✓ | [firecrawl.md](../../tools/coreyhaines-marketing/integrations/firecrawl.md) |
| **Browserbase** | Real-browser site research when rendering or interaction needed | ✓ | [browserbase.md](../../tools/coreyhaines-marketing/integrations/browserbase.md) |
