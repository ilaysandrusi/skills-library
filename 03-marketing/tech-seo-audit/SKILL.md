...
3. **Run tech-seo-auditor script** (if Python available): `python "${CLAUDE_PLUGIN_ROOT}/../../scripts/digital-marketing-pro/tech-seo-auditor.py" --url {url}` to get automated checks on status codes, redirects, meta tags, and page structure
