...
```bash
python "${CLAUDE_PLUGIN_ROOT}/../../scripts/digital-marketing-pro/plugin-metadata.py" --section environment
```
...
```bash
python "${CLAUDE_PLUGIN_ROOT}/../../scripts/digital-marketing-pro/drive-sync-state.py" --action write-config --data '{
...
```bash
python "${CLAUDE_PLUGIN_ROOT}/../../scripts/digital-marketing-pro/drive-sync-state.py" --action read-config
```
...
```bash
python "${CLAUDE_PLUGIN_ROOT}/../../scripts/digital-marketing-pro/drive-sync-state.py" --action profile-needs-upload --brand <brand>
```
