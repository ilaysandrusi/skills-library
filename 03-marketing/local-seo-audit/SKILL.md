...
3. **Run local-seo-checker script** (if Python available): `python "${CLAUDE_PLUGIN_ROOT}/../../scripts/digital-marketing-pro/local-seo-checker.py" --nap '{"name":"...","address":"...","phone":"..."}' --industry {industry}` for NAP consistency and GBP completeness scoring
