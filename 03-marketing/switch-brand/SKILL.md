...
```bash
python "${CLAUDE_PLUGIN_ROOT}/../../scripts/digital-marketing-pro/setup.py" --list-brands
```
...
```bash
python "${CLAUDE_PLUGIN_ROOT}/../../scripts/digital-marketing-pro/setup.py" --switch-brand BRAND_SLUG
```
