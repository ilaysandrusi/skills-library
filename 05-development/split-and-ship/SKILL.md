...
4. **Create or update PR**:
   ...
   - New branch: run the `/turbo-create-pr` skill targeting the appropriate base (default branch for independent groups, previous group's branch for stacked groups)
