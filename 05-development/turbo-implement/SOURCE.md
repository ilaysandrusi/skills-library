...
- Upstream path: `claude/skills/implement`
- Local skill path: `05-development/turbo-implement`
- License: MIT
...
Upstream names this skill `implement`, which is already taken in this library by an
unrelated skill from another source. It is filed here as
`turbo-implement`, and the frontmatter `name:` plus the `/implement` cross-references
