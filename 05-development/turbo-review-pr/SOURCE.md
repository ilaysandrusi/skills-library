...
- Upstream path: `claude/skills/review-pr`
- Local skill path: `05-development/turbo-review-pr`
- License: MIT
...
Upstream names this skill `review-pr`, which is already taken in this library by an
unrelated skill from another source. It is filed here as
`turbo-review-pr`, and the frontmatter `name:` plus the `/review-pr` cross-references
