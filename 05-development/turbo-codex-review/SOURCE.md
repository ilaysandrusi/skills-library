...
- Upstream path: `claude/skills/codex-review`
- Local skill path: `05-development/turbo-codex-review`
- License: MIT
...
Upstream names this skill `codex-review`, which is already taken in this library by an
unrelated skill from another source. It is filed here as
`turbo-codex-review`, and the frontmatter `name:` plus the `/codex-review` cross-references
