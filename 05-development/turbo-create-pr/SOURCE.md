...
- Upstream path: `claude/skills/create-pr`
- Local skill path: `05-development/turbo-create-pr`
- License: MIT
...
Upstream names this skill `create-pr`, which is already taken in this library by an
unrelated skill from another source. It is filed here as
`turbo-create-pr`, and the frontmatter `name:` plus the `/create-pr` cross-references
