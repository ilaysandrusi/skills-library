...
- Upstream path: `claude/skills/commit-staged`
- Local skill path: `05-development/turbo-commit-staged`
- License: MIT
...
Upstream names this skill `commit-staged`, which is already taken in this library by an
unrelated skill from another source. It is filed here as
`turbo-commit-staged`, and the frontmatter `name:` plus the `/commit-staged` cross-references
