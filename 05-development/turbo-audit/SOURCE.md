...
- Upstream path: `claude/skills/audit`
- Local skill path: `05-development/turbo-audit`
- License: MIT
...
Upstream names this skill `audit`, which is already taken in this library by an
unrelated skill from another source. It is filed here as
`turbo-audit`, and the frontmatter `name:` plus the `/audit` cross-references
