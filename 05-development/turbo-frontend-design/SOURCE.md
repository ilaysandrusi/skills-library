...
- Upstream path: `claude/skills/frontend-design`
- Local skill path: `05-development/turbo-frontend-design`
- License: MIT
...
Upstream names this skill `frontend-design`, which is already taken in this library by an
unrelated skill from another source. It is filed here as
`turbo-frontend-design`, and the frontmatter `name:` plus the `/frontend-design` cross-references
