...
CONFIG_PATH = os.path.expanduser("~/.config/seo-skills/google-api.json")
TOKEN_PATH = os.path.expanduser("~/.config/seo-skills/oauth-token.json")
...
def load_config() -> dict:
    ...
    Reads ~/.config/seo-skills/google-api.json first. Any missing fields
