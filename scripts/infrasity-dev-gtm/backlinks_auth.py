...
CONFIG_PATH = os.path.expanduser("~/.config/seo-skills/backlinks-api.json")
CACHE_DIR = os.path.expanduser("~/.cache/seo-skills/commoncrawl")
...
def load_config() -> dict:
    ...
    Reads ~/.config/seo-skills/backlinks-api.json first. Any missing fields
