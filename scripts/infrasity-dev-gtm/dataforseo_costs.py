...
Config: ~/.config/seo-skills/dataforseo-costs.json
Ledger: ~/.config/seo-skills/dataforseo-ledger.json
...
Security fixes: config path corrected to ~/.config/seo-skills/
"""
...
# ----- paths -----
CONFIG_DIR = Path.home() / ".config" / "seo-skills"
