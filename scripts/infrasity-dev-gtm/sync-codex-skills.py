...
# Skill domain configuration — top-level source directories in this repo.
SKILL_DOMAINS = {
    "skills": {
        "category": "dev-gtm",
        "description": "SEO, GEO, AI-discoverability, and documentation skills"
    },
    "marketing-skills": {
        "category": "marketing",
        "description": "Full-funnel developer-marketing skills"
    },
    "writing-skills": {
        "category": "writing",
...
def generate_skills_index(repo_root: Path, skills: List[Dict], dry_run: bool = False) -> Dict:
    ...
    index = {
        "version": "1.0.0",
        "name": "dev-gtm-claude-skills",
        "description": "Claude Code skills for SEO, GEO, AI discoverability, documentation, and developer marketing",
