...
seo-skills skills run under Claude Code, but also Cursor / Cursor Cloud
        ...
        if 'version' not in frontmatter["metadata"]:
            findings.append({
                ...
                "message": "metadata block present but no version field; "
                           "seo-skills's manifest test expects "
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Cross-platform portability lint for seo-skills SKILL.md files."
    )
