...
write_tool_readme() {
...

  {
    ...
    printf '### Script\n\n'
    printf '```bash\n'
    printf 'git clone https://github.com/infrasity-labs/dev-gtm-claude-skills.git\n'
    printf 'cd dev-gtm-claude-skills\n'
    printf '%s\n' "$script_install"
    printf '```\n\n'
    printf '## Verify\n\n'
    printf '%s\n\n' "$verify_step"
    ...
    printf -- '- https://github.com/infrasity-labs/dev-gtm-claude-skills\n'
  } > "${out_dir}/README.md"
}
