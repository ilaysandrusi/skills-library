...
LOCK_REL = pathlib.Path("seo-skills") / "seo-flow" / "references" / "flow-prompts.lock"
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="Sync Flow references into seo-skills/seo-flow/references/.",
        epilog=epilog,
    )
...
def sync(args):
    root = script_root()
    refs = root / "seo-skills" / "seo-flow" / "references"
