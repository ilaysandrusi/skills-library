...
# Use nutrition-analyzer to analyze nutritional status
/nutrition-analyzer
...
The following nutritional metrics can be obtained from health data:

- **Daily Energy Intake**: Through diet tracking
- **Macronutrient Ratio**: Protein/Fat/Carbohydrates
- **Micronutrients**: Vitamin and mineral intake
- **Water Intake**: Daily water consumption
- **Dietary Patterns**: Meal timing, frequency
...
A: A balanced diet includes appropriate amounts of macronutrients and sufficient micronutrients. General recommendations:
- Carbohydrates: 45-65% of total calories
- Protein: 10-35% of total calories
- Fat: 20-35% of total calories

**Q: How much water should I drink daily?**
A: Generally recommended 1.5-2 liters daily. Specific needs vary by weight, activity level, and climate.

**Q: How to calculate basal metabolic rate?**
A: Use the Mifflin-St Jeor formula:
...
**Q: How to track when dining out?**
A:
1. Estimate food portions
2. Choose similar food items
3. Record possible seasonings and oil amounts
4. Add appropriate estimation error margin

### Special Diets

**Q: What should diabetics eat?**
A: Follow these principles:
1. Control total carbohydrate intake
2. Choose low-GI foods
3. Distribute carbohydrates evenly
4. Eat at regular times and in fixed amounts

**Q: What should hypertensive patients pay attention to in their diet?**
A: DASH diet principles:
1. Low sodium (daily <2g sodium)
2. High potassium, magnesium, calcium
...
Nutrition data can be imported from the following platforms:

| Data Source | Data Type | Import Method |
|-------------|-----------|---------------|
| Apple Health | Nutritional intake | XML export |
| Fitbit | Calories, macronutrients | API or CSV |
| MyFitnessPal | Diet records | CSV export |
| Generic CSV | Custom nutrition data | Field mapping |

### Local Data Files

Nutrition-related data is saved in:

- `data/diet/**/*.json`: Daily diet records
- `data/profile.json`: Weight, BMI history
- `data/nutrition-summary.json`: Nutrition analysis summary
...
- Chinese Dietary Guidelines (2022): http://dg.cnsoc.org/
- USDA MyPlate: https://www.myplate.gov/
- WHO Healthy Diet: https://www.who.int/news-room/fact-sheets/detail/healthy-diet

## Related Skills

- **`nutrition`**: Record diet and nutritional intake
- **`nutrition-analyzer`**: Analyze nutritional status and trends
- **`weightloss-analyzer`**: Weight loss analysis and calculations
- **`diet`**: Diet recording command
