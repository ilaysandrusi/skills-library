...
- White coat effect identification

### Diabetes Assessment

Use the diabetes management features of the system:

```bash
# Use the diabetes command to manage diabetes
/diabetes

# Record blood glucose data
(through /data/glucose/)

# HbA1c tracking
(through /data/medical-records/)
```
...
Use the COPD management features of the system:

```bash
# Use the copd command to manage COPD
/copd
...
**High-Risk Groups** (diabetes, kidney disease):
- Target BP: <130/80 mmHg
- Home BP: <125/75 mmHg

**Elderly Patients** (>65 years):
- Target BP: <150/90 mmHg
- Can be lowered to <140/90 mmHg if well tolerated
...
- 2-hour postprandial glucose: <10.0 mmol/L

**Individualized Targets**:
- Young, newly diagnosed: HbA1c <6.5%
- Elderly, multiple comorbidities: HbA1c <8.0%
- History of severe hypoglycemia: More relaxed target

**Other Indicators**:
- Blood pressure: <140/90 mmHg
- LDL-C: <1.8 mmol/L (or <1.4 mmol/L for very high risk)
- BMI: 18.5-24.9 kg/m²

### COPD Management Targets

**Symptom Control**:
- CAT score: <10 points (mild impact)
- mMRC score: Grade 0-1

**Lung Function**:
- FEV1: Maintain as much as possible
- Reduce exacerbations: ≤1 moderate exacerbation per year

**Exercise Capacity**:
- 6-minute walk distance: Improve or maintain
...
**Drug Classes**:
1. **ACEI/ARB**: Prils, -sartans
2. **CCB**: Amlodipine, Nifedipine
3. **Diuretics**: Hydrochlorothiazide, Indapamide
...
6. **SGLT-2 inhibitors**: Dapagliflozin
7. **GLP-1 receptor agonists**: Liraglutide
...
3. **LABA+LAMA**: Combination preparations
...
### Chronic Disease Data Files

**Hypertension**:
- `data/blood-pressure/bp-readings.json`: Blood pressure records
- `data/hypertension-tracker.json`: Hypertension management data

**Diabetes**:
- `data/glucose/glucose-logs.json`: Blood glucose records
- `data/diabetes-tracker.json`: Diabetes management data

**COPD**:
- `data/copd-tracker.json`: COPD management data
- `data/symptoms/copd-symptoms.json`: Symptom records
...
- Blood vessels: Carotid ultrasound, PWV
- Kidneys: eGFR, urine albumin
- Fundus: Fundus examination
- Brain: Head CT/MRI

**Screening Frequency**:
- Annual target organ damage assessment
- Follow-up every 3-6 months

### Diabetes Complications

**Microvascular Complications**:
- Retinopathy: Annual fundus examination
- Nephropathy: Annual eGFR, urine albumin
- Neuropathy: Annual nerve screening

**Macrovascular Complications**:
- Cardiovascular: Risk assessment
- Cerebrovascular: Symptom assessment
- Peripheral vascular: Foot examination
...
- Chinese Guidelines for the Prevention and Treatment of Hypertension
- Chinese Guidelines for the Prevention and Treatment of Type 2 Diabetes
- Guidelines for the Diagnosis and Treatment of Chronic Obstructive Pulmonary Disease
...
- **`health-trend-analyzer`**: Chronic disease trend analysis
