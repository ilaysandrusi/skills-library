...
# Use mental-health-analyzer to analyze mental health
...
The following mental metrics can be obtained from health data:

- **Mood Score**: Daily mood level (1-10 scale)
- **Stress Level**: Stress intensity (low/medium/high)
- **Sleep Quality**: Sleep and emotion relationship
- **Emotional Triggers**: Events causing mood changes
- **Coping Methods**: Coping strategies used
- **Mood Patterns**: Emotional fluctuation patterns
...
**Daily Practices**:
1. **Regular Schedule**: Maintain stable sleep-wake cycles
2. **Physical Activity**: At least 30 minutes of exercise daily
3. **Healthy Diet**: Balanced nutrition, limit caffeine and alcohol
4. **Social Connection**: Maintain important relationships
5. **Mindfulness Practice**: 10-15 minutes of meditation or relaxation daily
6. **Self-Compassion**: Set aside time for yourself
...
- Write in an emotion journal
- Talk with trusted individuals
...
Mental health data primarily comes from:

- **Mood Records**: Manual daily emotion input
- **Stress Assessment**: Manual stress level recording
- **Sleep Data**: Sleep quality affects emotions
- **Physiological Indicators**: Heart rate variability, etc.

### Local Data Files

Mental health-related data is saved in:

- `data/mood/mood-records.json`: Daily mood records
- `data/mental-health/assessments.json`: Psychological assessments
- `data/stress/stress-logs.json`: Stress records
...
**Q: How to identify mental health problems?**
...
2. Change stressful environment
...
- Self-coping strategies are ineffective

**Q: How to find mental health professionals?**
A: You can find through:
1. Primary care physician referral
2. Health insurance provider list
...
- Anxiety and depression affect blood pressure control
- Mental health affects medication adherence
...
**Psychology and Blood Sugar**:
- Stress affects blood sugar levels
- Diabetes distress is common
- Depression is more common in diabetics

**Improvement Recommendations**:
- Accept diabetes as a chronic condition
- Seek diabetes support groups
- Manage diabetes distress
...
- Anxiety is associated with heart symptoms
...
- Chinese Mental Health Association: http://www.camp.org.cn/
- American Psychological Association (APA): https://www.apa.org/
- Mental Health Screening Tools: https://screening.mentalhealthscreening.org/

## Related Skills

- **`mood`**: Record emotions
- **`mental-health`**: Record mental health assessments
- **`mental-health-analyzer`**: Analyze mental health trends
- **`sleep-analyzer`**: Sleep and mental health correlation analysis
...
**Categories**: #mental-health #stress #emotions #mindfulness
