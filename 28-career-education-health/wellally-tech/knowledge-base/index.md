...
- **Secure & Private**: Bank-level encryption protection
- **Cross-Platform**: Support for desktop, tablet, and mobile devices
- **28 Feature Modules**: Covering all aspects of health management

## Category Index

### 1. Nutrition & Diet

Detailed articles: [nutrition.md](nutrition.md)

**Core Topics**:
- Dietary management and nutrition balance
- Food database queries (100,000+ foods)
...
Detailed articles: [fitness.md](fitness.md)
...
Detailed articles: [sleep.md](sleep.md)

**Core Topics**:
- Sleep quality assessment
- Sleep stage analysis (deep sleep, light sleep, REM)
...
Detailed articles: [mental-health.md](mental-health.md)

**Core Topics**:
- Stress management
- Mood tracking and interpretation
- Anxiety and depression identification
...
Detailed articles: [chronic-disease.md](chronic-disease.md)
...
- `#hypertension` `#diabetes` `#COPD` `#heart-disease` `#high-cholesterol`
- `#insomnia` `#anxiety` `#depression` `#stress`
- `#obesity` `#overweight` `#malnutrition`

### By Data Type

- `#blood-pressure` `#blood-sugar` `#heart-rate` `#weight` `#BMI`
- `#sleep` `#steps` `#calories` `#exercise`
- `#medication` `#lab-results` `#symptoms` `#allergies`

### By Management Type

- `#monitoring` `#recording` `#analysis` `#reporting`
- `#prevention` `#treatment` `#rehabilitation` `#care`
- `#diet` `#exercise` `#lifestyle` `#behavior-change`

## Usage Guide

### How to Find Articles

1. **Browse by Category**: Choose from 5 main categories above
2. **Search by Topic**: Use "Browse by Topic" section to find specific health topics
3. **Filter by Tags**: Use search tags to quickly locate relevant articles
4. **View Popular Articles**: Browse most popular content

### Article Recommendation Logic

The system will recommend relevant articles based on your health data:

```javascript
// Example recommendation logic
if (blood_pressure > 140/90) {
  recommend: [
    "Hypertension Monitoring Basics",
    "Dietary Strategies for Lowering Blood Pressure",
    "Antihypertensive Medication Adherence"
  ]
}

if (sleep_duration < 6_hours) {
  recommend: [
...
- **`sleep-analyzer`**: Sleep analysis, recommend sleep improvement articles
- **`fitness-analyzer`**: Exercise analysis, recommend fitness-related articles
- **`mental-health-analyzer`**: Mental health analysis, recommend mental health articles
- **`hypertension`**: Hypertension management, recommend blood pressure control articles
- **`diabetes`**: Diabetes management, recommend blood sugar control articles

## Update Log

### 2025-01-22
- Created knowledge base index
- Added 5 main categories
- Organized popular article links
- Added topic browsing functionality
