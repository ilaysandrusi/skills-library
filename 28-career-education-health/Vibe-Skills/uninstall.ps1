...
function Show-WrapperUsage {
  Write-Output 'Usage: uninstall.ps1 [-SkillsDir <path>] [-Help|-?]'
  Write-Output 'Uninstalls only the receipt-owned Vibe files under <SkillsDir>\vibe.'
}
...
$argsList += @('-m', 'vgo_cli.main', 'uninstall', '--repo-root', $RepoRoot)
