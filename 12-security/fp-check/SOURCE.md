...
|---|---|---|---|
| `agents/` | 3 | `plugins/fp-check/agents/` | trailofbits/skills: upstream `plugins/fp-check/` contains exactly this one skill plus these agents |
| `hooks/` | 1 | `plugins/fp-check/hooks/` | trailofbits/skills: upstream `plugins/fp-check/` contains exactly this one skill plus these hooks |
