...
|---|---|---|---|
| `commands/` | 1 | `plugins/entry-point-analyzer/commands/` | trailofbits/skills: upstream `plugins/entry-point-analyzer/` contains exactly this one skill plus these commands |
