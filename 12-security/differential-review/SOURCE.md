...
|---|---|---|---|
| `agents/` | 1 | `plugins/differential-review/agents/` | trailofbits/skills: upstream `plugins/differential-review/` contains exactly this one skill plus these agents |
| `commands/` | 1 | `plugins/differential-review/commands/` | trailofbits/skills: upstream `plugins/differential-review/` contains exactly this one skill plus these commands |
