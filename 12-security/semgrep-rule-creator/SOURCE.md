...
|---|---|---|---|
| `commands/` | 1 | `plugins/semgrep-rule-creator/commands/` | trailofbits/skills: upstream `plugins/semgrep-rule-creator/` contains exactly this one skill plus these commands |
