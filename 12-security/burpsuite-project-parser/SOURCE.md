...
|---|---|---|---|
| `commands/` | 1 | `plugins/burpsuite-project-parser/commands/` | trailofbits/skills: upstream `plugins/burpsuite-project-parser/` contains exactly this one skill plus these commands |
