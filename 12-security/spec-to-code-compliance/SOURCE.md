...
|---|---|---|---|
| `agents/` | 1 | `plugins/spec-to-code-compliance/agents/` | trailofbits/skills: upstream `plugins/spec-to-code-compliance/` contains exactly this one skill plus these agents |
