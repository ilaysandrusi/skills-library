...
|---|---|---|---|
| `commands/` | 1 | `plugins/firebase-apk-scanner/commands/` | trailofbits/skills: upstream `plugins/firebase-apk-scanner/` contains exactly this one skill plus these commands |
