...
|---|---|---|---|
| `agents/` | 1 | `plugins/audit-context-building/agents/` | trailofbits/skills: upstream `plugins/audit-context-building/` contains exactly this one skill plus these agents |
