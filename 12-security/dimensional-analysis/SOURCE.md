...
|---|---|---|---|
| `agents/` | 5 | `plugins/dimensional-analysis/agents/` | trailofbits/skills: upstream `plugins/dimensional-analysis/` contains exactly this one skill plus these agents |
