...
- Upstream path: `plugins/skill-forge-essentials/skills/ai-debt-detector`
- Local skill path: `08-context-engineering/ai-debt-detector`
- License: MIT
...
`skill-forge-essentials` plugin's `skills/` tree. Everything listed above lives inside that
