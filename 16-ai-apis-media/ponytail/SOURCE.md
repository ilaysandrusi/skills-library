...
- Local skill path: `16-ai-apis-media/ponytail`
...
`ponytail` is an external MIT skill (github.com/DietrichGebert/ponytail) that OmniRoute vendors under `skills/`. Imported because it lives in `skills/` at HEAD; it is not OmniRoute-specific.
