...
- Upstream path: `skills/migrate-postgres-tables-to-hypertables`
- Local skill path: `25-data-databases/migrate-postgres-tables-to-hypertables`
...
Partition-column selection, in-place versus blue-green migration, and post-migration validation. The execution stage of the TimescaleDB trio.
