...
- Upstream path: `skills/find-hypertable-candidates`
- Local skill path: `25-data-databases/find-hypertable-candidates`
...
SQL that analyses an existing schema and scores each table for hypertable conversion. The diagnostic stage of the TimescaleDB trio.
