...
- Upstream path: `skills/pgvector-semantic-search`
- Local skill path: `25-data-databases/pgvector-semantic-search`
...
Vector similarity search with pgvector: HNSW and IVFFlat index choice, halfvec storage, binary quantization, filtered search and recall tuning. Imported because pgvector had no dedicated skill — it appeared only as a one- or two-line mention in eight unrelated skills.
