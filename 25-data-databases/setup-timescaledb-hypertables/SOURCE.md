...
- Upstream path: `skills/setup-timescaledb-hypertables`
- Local skill path: `25-data-databases/setup-timescaledb-hypertables`
...
Hypertable creation, compression, retention policies, continuous aggregates and indexing. TimescaleDB had essentially no coverage in the library before this.
