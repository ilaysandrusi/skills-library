...
- Local skill path: `25-data-databases/design-postgis-tables`
...
PostGIS spatial table design: geometry vs geography, SRIDs, spatial indexing and location-query patterns. Imported because PostGIS had no dedicated skill in the library — it appeared only as a passing mention in two unrelated skills.
