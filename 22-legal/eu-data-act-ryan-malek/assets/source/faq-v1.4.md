# European Commission FAQ on the Data Act — version 1.4 (22 January 2026)

**Verbatim source.** This file contains the unabridged text of every question and answer in the Commission's FAQ document on the Data Act, version 1.4, as published on the Commission's Digital Strategy site.

- Authoritative source: https://digital-strategy.ec.europa.eu/en/faqs/data-act-explained-frequently-asked-questions
- Version: 1.4
- Published: 22 January 2026

**The FAQ is non-authoritative.** The opening pages of the document state expressly:
...
Outputs that rely on the FAQ must always frame it as "the Commission's interpretation, not binding."

This file is the sole FAQ source the skill reads at runtime. **Never paraphrase from memory; always quote from this file.**

If a needed FAQ question is missing from this file, that is a coverage defect. Stop and report it; do not answer without source.
...
> Internet-of-Things (IoT) objects). In other cases, the Data Act restricts the re- use of data by third parties
...
**How does the relationship between the Data Act and the GDPR affect the 
...
**How does the Data Act interact with data-sharing obligations under other EU 
legislation?**

> The Data Act is a horizontal piece of legislation that aims to significantly enhance fair access to and use
> of data across all sectors of the economy. Chapter III, in particular, establishes a framework regarding the
...
> modalities (e.g. safety, standardisation, or technical matters ) and with specific limits on data holders’
...
> unnecessary complexity. The principles of the Data Act apply f or all matters related to ‘access to data’
> that are not specifically regulated in such sectoral rules.
> Access to and use of data in the Internet-of-Things context
> An example of Chapter II in practice
>
> Section on data in scope

## FAQ Q4

**Which data are in scope?**

> Several factors determine which data are covered by the data access right s provided for in Articles 3, 4
...
> to mandatory data-sharing obligations that are regulated by Chapter II.
> Access and use of IoT data – Chapter II of the Data Act
> Factor Explanation Reference in
> the legal text
> Product data
> Data obtained, generated, or collected by a connected product and
> which relates to its performance, use or en vironment. Purely
> descriptive data that accompanies the connected product (e.g. in
...
> quantity or quality or a change in a physical quantity (e.g.
...
> of proprietary, complex algorithms ). In addition, c ontent that is
...
>
> However, personal data processing is governed by GDPR rules , so
> the user’s rights provided by the Data Act have to be exercised in
> compliance with the GDPR. Users that are not data subjects or data
> holders must have a valid legal basis under Art icle 6 of the GDPR
...
> example, continues to apply. The Data Act establishes a new
...
**What level of enrichment transforms raw and pre-processed data into 
inferred or derived data, excluding it from Chapter II?**

> Chapter II of the Data Act considers the level of enrichment of the data a s one of the key factors in the
...
> Users, or third parties chosen by the user, are expected to have a reasonable level of technical capabilit y
...
**How does Chapter II apply to IoT data processed at the edge?**
...
> important to emphasise that the Data Act does not seek to override or weaken data protection or privacyfocused design principles.
> Chapter II of the Data Act requires data holders to make available all “readily available” data [i.e. raw or
...
> exclusively locally without any external transmission, Chapter II obligations are in principle not triggered.
...
> Chapter II aims to ensure balanced sharing practices without imposing unreasonable technical or economic
...
**What does the exclusion of “content” from the scope of data under Chapter II 
mean?**
...
> should fall in scope of Chapter II of the Data Act.
...
> 14).
> Products which primarily fulfil the function of storing, processing, or transmitting data (e.g. servers and
> routers) are outside the scope of the mandatory data-sharing obligations under Chapter II of the Data Act,
> unless they are owned, rented, or leased by the user.
> Similarly, t he fact that a connected product ( e.g. a wagon, airplane, or vehicle) must use certain
...
**What determines whether a connected product falls in scope of the Data Act?**
...
> physically present in that third country and brought by th at consumer into the EU for their personal use,
> and (ii) when the product is manufactured in a Member State with a view to exporting it to a third country.
...
**What happens if a connected product that is placed on the EU market 
...
> by that connected product both in side and out side the EU should be made available to the user in
...
**What happens if a connected product is resold (‘second-hand connected 
products’)?**

> When it comes to the user’s right to access data generated by the use of a connected product, t he Data
...
**How do the obligations under Chapter II of the Data Act relate to 
...
>
> carried out in accordance with applicable legislation. In other words, the specific need for a connected
...
**Does applying privacy-enhancing technologies to achieve anonymisation or 
...
> applying privacy enhancing technologies (PETs). It cannot be concluded that d ata resulting from applying
> PETs should be treated as inferred or derived data solely due to the application of these technologies. A s
> made clear in Recital 15, the protection to data holders’ inferred or derived data is intended to safeguard
...
**How does anonymisation or severing the link between stored data and its 
...
> retain certain data (e.g. for regulatory oversight or product safety). In such cases, PETs can mitigate certain
...
**Can there be multiple users for a single connected product, and how should 
...
> access the data to which they are entitled . Users might also conclude separate agreements (e.g. a userto-user sub-lease of a connected product).
...
**How can I, as a user, access my data?**

> Article 3(2) and 3(3) of the Data Act oblige sellers, rentors, l essors, or prospective providers of related
...
> Article 3 of the Data Act leaves some flexibility ( ‘where relevant and technical ly feasible’) to a
...
> situations where data holders prefer to offer indirect access to the data. The Data Act incentiv ises data
>
> holders to put in place solutions that work best for them when they have to comply with the obligation of
> making data available to the user.

## FAQ Q18

**How does the Data Act complement the GDPR’s data portability rights?**

> Article 1(5) of the Data Act clarifies the relationship between the Data Act and the GDPR, namely that
> Articles 4 and 5 of the Data Act (right to access and share data from IoT devices) complements Articles
...
> portability right specifically for the IoT context. Thanks to the Data Act, users ( e.g. data subjects and
...
**In which situations can users monetise their non-personal data?**
...
> 25 of the Data Act explains that, in business-to-business relations, an arr angement between the data
...
**What are the options for users, especially consumers, if the right to access 
and use data is not properly exercised?**

> The Data Act ensures a high level of consumer protection. Art icle 1(9) states that the Data Act
...
> • Users (including consumers) can lodge a complaint with the relevant competent authority. If they are
...
> • Users who are consumers can use the instruments available to them under EU consumer protection
> legislation. They can in particular lodge a complaint with the European Consumer Centres Network in
>
> the event that the data holder is established in a Member State other than that in which the consumer
> resides.
> • Users who are data subject s can contact the relevant DPA regarding all issues concerning the
...
> service provider must necessarily enter into a contract with the user, in line with Article s 3(3)
> and 4(13) of the Data Act. The related service provider therefore becomes a data holder.
> In order for there to be an obligation on a data holder under Chapter II of the Data Act, there must always
...
**Does Article 3(1) oblige manufacturers of connected products to design or 
...
> • The user is able to access the data without the intervention of any other party, notably the
> data holder (this is an alternative to making requests under Articles 4 and 5, which do require
> data holder intervention).
>
> • The user has the technical means to stream or download the data as a result of the design of
...
**What technical and practical requirements must data holders meet 
...
> • Format: Data holders must make data available “in a comprehensive, structured, commonly
...
> Act.
> • Quality: The data holder is required to share data “ of the same quality” , i.e. as accurate,
...
> • Timeliness: Articles 4(1) and 5(1) require data holders to provide data “without undue delay”
...
> • Latency: The requirement to provide data “ where relevant and technically feasible,
> continuously and in real-time” applies to scenarios where low latency is beneficial, such as IoT
...
> therefore be assessed objectively, based on i ndustry standards and best practices. Data
...
> • Convenience: Data holders must grant access to data “easily”. Th is requires implementing
...
> • Security: Data must be made available “securely”, ensuring protection against unauthorised
...
**Does the new data access right affect the protection of trade secrets?**
...
> confidentiality (Articles 4(6) and 5(7) of the Data Act). These safeguards need to be in place prior to
>
> the sharing of data. Possible measures could include model contractual terms, confidentiality
...
> damage’ means serious and irreparable economic loss. Such decisions need to be made on a case-bycase basis.
...
**Can the protections that Article 4, 5 and 6 provide for also apply in relation 
...
**Does a data holder have to share data if there are safety/security concerns?**

> Pursuant to Article 4(2) of the Data Act, users and data holders can agree to restrict or refuse to share
...
> This mechanism (i.e. the possibility of restricting or prohibit ing data access on the basis of safety or
...
**What GDPR legal bases could the data holder rely on when replying to a 
request for data?**

> Different scenarios and different processing operations need to be distinguished.
> • The user is the data subject in relation to the data in question
...
> • The user is not the data subject in relation to the data in question
...
**Should the data holder verify that the user or third party has a valid 
...
> ensure that they have sufficient information to d o so. The controller should cooperate to share strictly
> necessary information to allow to demonstrate the compliance by each of them.

## FAQ Q26

**A non-compete clause for connected products has been introduced. Does this 
...
> As a result of the limitation of the non- compete clause to connected products only , b usinesses and
...
**How are the interests of data holders protected?**
...
> Chapter II to raw and pre -processed data. This minimises adverse effects on data- related
> investments and on the protection of trade secrets or IPR.
> ii. Specific provisions address the situation where data requested by the user are considered trade
> secrets by the data holder/trade secrets holder or where the use of data is linked to
> considerable safety risks.
> iii. Data access from connected products under the Data Act cannot be used to develop a
> competing product.
...
**Does the Data Act apply to manufacturers of connected products and 
...
**Are there any limitations on the data holder’s use of the data generated by 
the user?**

> While the GDPR governs processing of personal data, Article 4(13) and (14) of the Data Act cover the use
...
**How would a data holder be able to verify a legitimate user?**
...
> product; (ii) the type of user (consumer vs industrial) ; (iii) the number of likely users ( single owner of an
...
>
> up differentiated user accounts; and (vii) the ease of use of such accounts for the actual consumers. Where
> applicable, solutions such as the EU Digital Identity Wallet could be envisaged.
> With respect to personal data, R ecital 34 of the Data Act explains that ‘Personal data may only be
...
> their obligations under the GDPR when requesting personal data from IoT devices.

## FAQ Q31

**Does a data holder still need to share data with a third party upon request 
...
> that there is a data holder with data readily available to them. Article 5 is not condition al upon the type
> of access that the user has.

## FAQ Q32

**Can users request access to historical data that a data holder might be 
...
> users might have a legitimate interest in such data (e.g. in respect of updates or incidents), while keeping
...
**Can users request that data holders delete their non-personal data before 
...
>
> If there is a contractual agreement for users to erase data, information on how data can be erased is one
...
**Can a company be both a user and a data holder at the same time?**
...
**After the Data Act enters into application, can data holders continue to 
...
> • conclude a contract that secures the user’s agreement to their use of the data, if they were
> doing so without a contractual basis, or
> • check if an existing contract (e.g. a sales contract, a contract for the provision of related
...
> expectation of being able to collect and use this dat a. Furthermore, without being able to
> identify the user, this data holder would not be in a situation where they could use the data
>
> to derive insights about the user’s economic situation, assets and production methods, as
...
**What can a third party do with the data they receive from a user/data 
...
**Can users oblige data holders to share data with Digital Markets Act 
gatekeepers?**
...
> platform ecosystems and superior bargaining power. Requiring mandatory data sharing for IoT data with
> DMA gatekeepers would therefore be unfair to those who must comply , and unnecessary given the goals
> of the Data Act. DMA gatekeepers cannot therefore be third parties in the sense of the new IoT data access
> right established under the Data Act.
>
> This does not mean that DMA gatekeepers are entirely excluded from the IoT (data) market . DMA
...
**Can someone established in a third country receive data on the basis of the 
data-sharing obligations under Chapter II?**

> No. The scope of the Chapter II data-sharing obligation on data holders is limited to entities and persons,
...
>
> Irrespective of its place of establishment, a data holder has a legal obligation to share data with an EU based entity or person at the request of an EU user. A user may ask a data holder to share data with a n
...
**Is it possible to differentiate between the data recipients and apply 
...
> in a comparable category must be done on a case-by-case basis.

## FAQ Q39

**Is there an upper limit to reasonable compensation?**
...
> objective criteria (e.g. costs incurred, or the volume of data bei ng made available ). Reasonable
> compensation cannot include a profit margin i f the recipient is an SME or a non -profit research
> organisation.

## FAQ Q40

**Who can rely on the dispute settlement mechanism established by the Data 
...
> (ii) for disputes relating to the fair, reasonable and non -discriminatory terms and conditions for, and
...
> relations.
>
> The rules on dispute settle ment are applicable to disputes relating to the fair, reasonable and non discriminatory terms and conditions for (and transparent manner of) making data available in businessto-business relations, where the obligation to share data is enshrined in law (including the Data Act itself).
...
> to the dispute. In addition, a decision of a dispute settlement body binds the parties only if the y have
...
**What special provisions exist to help SMEs, given that they are often in a 
...
**I think that the data-sharing contractual terms in my contract are unfair. 
What can I do?**
...
>
> Thirdly, the terms in question might fall into a different category: terms which are only pres umed to be
...
> terms will continue to be binding if the unfair term can be separated from them (i.e. it is sufficiently standalone). If the imposing party disputes the outcome of the assessment and does not withdraw the term,
> the matter can be brought in front of a competent authority, the courts or (if the other party agrees) a
> dispute settlement body.

## FAQ Q42a

**To which extent does the unfairness control in Article 13 of the Data Act 
...
> access to and use of the data as well as liab ility or remedies for breach or termination of data related
...
> and use or b) liability and remedies for the br each of data related obligations. Such contractual terms
...
> Act applies to such clauses to the extent th at data access and use or data- related obligations are
> concerned. For example, the unfairness control would apply to the general terms and conditions about
> liability and remedies, if these cover breach of data related obligations. However, the unfairness c ontrol
> provided by Article 13 would not apply to the clauses regulating the terms for the bank loan, as explained
> above.

## FAQ Q42b

**Does Chapter IV of the Data Act apply to c ontracts concluded before the 
Data Act started to apply?**

> As a general rule, the Data Act applies from 12 September 2025. In accordance with the exception in
> Article 50, the unfairness control (Chapter IV Article 13) only applies:
>
> • to contracts concluded after 12 September 2025, and
> • starting from 12 September 2027 to contracts concluded on or before 12 September 2025, if these contracts
...
**What qualifies as ‘mitigation of or recovery from’ a public emergency?**
...
**What does the term ‘equivalent conditions’ mean in the context of Article 
15(1)(a)?**
...
> not be obtained elsewhere, whil e at the same time requiring a comparable amount of effort. The last
> sentence of Recital 64 provides some examples in this regard.

## FAQ Q45

**Could the new rights under the Data Act endanger data holders’ existing 
...
**How can a data holder verify that a Chapter V request is justified and 
lawful?**

> Data holders should verify the following:
> • Is the requesting entity a public sector body of a M ember State or one of the EU -level entities
> listed in Article 17(1) of the Data Act?
> • Is there sufficient and clear justification regarding the choice of the data holder, the scope of
...
>
> • Is the request proportionate (e.g. in terms of data scope and granularity) to the exceptional need
> described?
> • If personal data are requested – are the necessary conditions described in Articles - 17(1)(g) and
> 17(2)(e) fulfilled?
> • Have all the relevant authorities been notified (e.g. if the request is made by a public sector body
> from a different Member State)?
> • In the case of justified doubts as to the conditions listed above, the data holder should be able
...
**Can a public body in one country request data from a data holder in a 
different country?**

> Are the rights of the data holder fully protected in such a
> case?
...
> holder’s protection. Such requests are always notified to the competent authority of the d ata holder’s
> Member State for ex ante examination.

## FAQ Q48

**Once data are made available following a request, do they become public 
sector information?**

> Can the public sector body use them in any way it sees
> fit?
...
>
> Data that are shared under the mechanism described in Article 21 must be deleted no later than 6 months
> after the fulfilment of the original purpose for which the data had been requested.

## FAQ Q49

**Can a request under Chapter V be made repetitively or simultaneously by 
...
> should first check if the data are already available within the public sector. T he Data Act therefore
...
**Could Chapter V be used by governments in a way that puts citizens’ 
...
**Can a public sector body be a ‘user’ of a connected product/related service 
under Chapter II?**

> Yes. Nothing prevents a public sector body (as a separate legal entity) from becoming a user in the sense
> of Chapter II of the Data Act (see Recital 18).
>
> Switching between data processing services

## FAQ Q52

**Which services are excluded from the scope of Chapter VI?**
...
> services. The concept is designed to cover the popular delivery models - Infrastructure as a Service (IaaS),
...
**What is the difference between exportable data and digital assets?**
...
> respective data processing service. T hese concepts exclude data protected as intellectual property and
...
> settings, security and access and control rights management. Applications as well as virtualis ation
...
**What is the deadline for providers to reduce switching charges so that they 
...
>
> provider may still bill the customer for the costs incurred for data egress, even after 12 January 2027.
...
**What does ‘free-tier offering’ mean?**
...
**How do the notice period and the transition period relate to one another?**
...
**How will the Commission create the common Union repository for the 
...
**What is the state of play regarding the standard contractual clauses for 
...
**Do the Data Act provisions on data processing services also apply to 
PaaS and SaaS?**
...
> Institute of Standards and Technology and covers IaaS, PaaS, and SaaS. This is confirmed by Recital 81
> which lists IaaS, PaaS and SaaS as data processing service delivery models.
...
> • They enable access to computing resources, including networks, servers, storage, applications,
> and services;
> • They enable on -demand network access, meaning that a customer can unilaterally provision
> these computing resources which are available over the network and through standard
> mechanisms, for example via mobile phones, laptops, or workstations;
> • They can be rapidly provisioned and released with minimal management effort or service
> provider interaction, which implies that the unilateral provision can be done without significant
> intervention from the service provider and can be deployed quickly, all owing organisations to
...
>
> relationship with a provider of data processing services with the objective of using one or more data 40
...
> the concept of functional equivalence laid down in Article 30(1) only applies to providers of IaaS, whereas
...
> time. While neither of those two exemptions single out SaaS, it is possible that a specific SaaS solution
> meets these criteria and thus benefits from a lighter regime.

## FAQ Q58b

**Is the source provider responsible for assisting the customer in rebuilding 
...
> Recital 92 provides further clarification in explaining that “ [t]his Regulation does not require providers of
> data processing services to develop new categories of data processing services, including within, or on the
> basis of, the ICT infrastructure of different providers of data processing services in order to guar antee
...
> of IaaS. Recital 92 explains that this obligation is limited to the source provider’s service environment.
...
>
> services compatible with harmonised standards or open interoperability specification if and w hen these
...
> to the obligations of source providers of IaaS thus also apply to source providers of PaaS and SaaS.
...
>
> Unlawful access to and transfer of non-personal data held in
> the EU by third country authorities

## FAQ Q59

**Does the Data Act create data localisation requirements?**

> The Data Act does not limit companies’ ability to transfer non-personal data internationally. It does not
> change the prohibition of national data localisation requirements as presented in the Free Flow of Non personal Data Regulation.
...
> of an international agreement, the request must comply with certain procedural safeguards that are
...
**Does Article 32 cover international data transfers between or inside 
businesses?**
...
> EU or Member State law. International transfers of personal data are regulated under the GDPR.

## FAQ Q62

**What measures should data processing service providers implement to 
...
> encourages the development, deployment, and regular update of these measures.
...
**Which bodies can a data processing service provider consult before deciding 
...
> Assistance Treaties (MLATs). In the case of France, it could for example be the Bureau de l'entraide pénale
...
**Can the Commission impose common specifications instead of standards?**
...
> supplement the Data Act by adopt ing delegated acts which further specify those essential requirements
...
> standards and common specifications can be pu blished in the repository. Common specifications can be
...
**Is the Commission intending to replace existing (e.g. sectoral) standards?**
...
**Do the essential requirements in Article 36 affect national contract law?**
...
> not the agreements as such - are regulated by the Data Act.
>
> Enforcement

## FAQ Q67

**What bodies should Member States put in place to ensure that the Data Act 
is enforceable?**

> The Member States are required to designate at least one competent author ity to deal with the
...
> It is important to note that the D PAs remain responsible for monitoring the application of the Data Act
...
> Board, to ensure the seamless and uniform application of th e Data Act. This effort may include issuing
> sector-specific guidelines for the effective application of data access and use rules.

## FAQ Q68

**Which public authority can help me if I consider that my rights under the 
...
**What is the role of the Commission in the enforcement of the Data Act?**
...
> players in observing the rights and obligations introduced by the Data Act, t he Commission will also
...
**Are penalties harmonised across the EU?**

> The Member States are responsible for setting penalties and all the necessary measures relative to their
> application. However, to ensure high consistency across the EU, the E DIB will be used as a platform to
...
> infringements of the obligations laid down in Chapter II, III and V of the Data Act. The E DPS may, within
...
**When should a legal representative be designated?**
...
> but are established outside the EU. All such entities must designate an EU -based representative. T he
...
**When will the Commission publish the guidance on reasonable 
compensation?**

> In line with Article 9(5) of the Data Act, t he European Data Innovation Board must be consulted on t he
...
**What are the next steps regarding interoperability?**
...
> Cenelec and ETSI), the E U stakeholder organisations representing consumers, environmental interests,
...
**What is the state of play of the model contractual terms for data sharing 
...
> The MCTs cover contracts between d ata holders and users, data holders and data recipients, users and
