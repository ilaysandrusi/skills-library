...
> **Careful:** hooks are executable code that a coding agent runs automatically. Read a hook before wiring it up. `zero/zero/ensure-runner.sh` in particular downloads a Node runtime and installs an npm CLI into your home directory.

**Total files:** 113 — from 23 source projects.
...
| [`claude-ecom/`](./claude-ecom/) | 1 | [takechanman1228/claude-ecom](https://github.com/takechanman1228/claude-ecom) | MIT |
...
| [`data-structure-protocol/`](./data-structure-protocol/) | 6 | [k-kolomeitsev/data-structure-protocol](https://github.com/k-kolomeitsev/data-structure-protocol) | Apache-2.0 |
...
| [`last30days/`](./last30days/) | 2 | [mvanhorn/last30days-skill](https://github.com/mvanhorn/last30days-skill) | MIT |
...
| [`trailofbits/`](./trailofbits/) | 11 | [trailofbits/skills](https://github.com/trailofbits/skills) | CC-BY-SA-4.0 |
| [`understand-anything/`](./understand-anything/) | 3 | [Lum1104/Understand-Anything](https://github.com/Lum1104/Understand-Anything) | MIT |
| [`zero/`](./zero/) | 5 | [officialzeroxyz/zero-plugins](https://github.com/officialzeroxyz/zero-plugins) | NOASSERTION |
