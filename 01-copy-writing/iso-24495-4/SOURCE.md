...
- Upstream path: `skills/iso-24495-4`
- Local skill path: `01-copy-writing/iso-24495-4`
- License: MIT
- Discovered: 2026-08-23

## What this skill is

Organisational implementation, provisional (ISO/CD 24495-4 committee draft). The only task skill in the pack, and the only one with executable tooling: a corpus audit, an evidence sweep, a five-dimension maturity model with deterministic scoring, and an append-only audit trend, all TypeScript run with Bun and covered by `bun test`.
...
- `assets/` — 1 file(s): report templates the skill fills in
- `references/` — 3 file(s): extended reference documents the SKILL.md links to
- `scripts/` — 11 file(s): the TypeScript tooling the skill runs, with its `lib/` modules
- `tests/` — 36 file(s): the Bun test suite and its fixtures, which is how the tooling is verified
