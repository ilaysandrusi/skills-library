...
- Upstream path: `codex-skills/iso-24495-style`
- Local skill path: `01-copy-writing/iso-24495-style`
- License: MIT
- Discovered: 2026-08-23

## What this skill is

The response style as a skill, for Codex. Claude Code carries the same rules as an output style (archived at `rules/iso-24495/iso-24495.md`); Codex has no output style, so upstream ships them here instead.
