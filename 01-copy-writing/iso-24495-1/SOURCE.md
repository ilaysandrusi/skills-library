...
- Upstream path: `skills/iso-24495-1`
- Local skill path: `01-copy-writing/iso-24495-1`
- License: MIT
- Discovered: 2026-08-23

## What this skill is

Core plain-language principles (ISO 24495-1:2023). Governs every user-facing response and routes to the sector skills.
