...
- Upstream path: `skills/iso-24495-5`
- Local skill path: `01-copy-writing/iso-24495-5`
- License: MIT
- Discovered: 2026-08-23

## What this skill is

Document design, provisional (ISO/WD 24495-5 working draft): visual hierarchy, navigation aids, tables for comparisons.
...
- `assets/` — 3 file(s): report templates the skill fills in
- `tests/` — 3 file(s): the Bun test suite and its fixtures, which is how the tooling is verified
