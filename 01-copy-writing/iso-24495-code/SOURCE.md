...
- Upstream path: `skills/iso-24495-code`
- Local skill path: `01-copy-writing/iso-24495-code`
- License: MIT
- Discovered: 2026-08-23

## What this skill is

The same principles applied to what a person reads in source: declaration order, names, comments, and error messages.
