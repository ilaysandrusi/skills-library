...
- Upstream path: `skills/iso-24495-text-audit`
- Local skill path: `01-copy-writing/iso-24495-text-audit`
- License: MIT
- Discovered: 2026-08-23

## What this skill is

User-invoked audit of a selected `.md`, `.markdown` or `.txt` file or directory. Reports mechanical findings with locations and never decides compliance. Its frontmatter sets `disable-model-invocation: true`, so it never activates on its own.
...
- `scripts/` — 2 file(s): the TypeScript tooling the skill runs, with its `lib/` modules
