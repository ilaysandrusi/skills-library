...
analysis (existing seo-skills skills) and Google's real-time field data: actual
...
```bash
python ../../scripts/infrasity-dev-gtm/google_auth.py --check --json
```
...
**Script:** `python ../../scripts/infrasity-dev-gtm/pagespeed_check.py <url> --json`
...
**Script:** `python ../../scripts/infrasity-dev-gtm/pagespeed_check.py <url> --crux-only --json`

### `/seo google crux-history <url>`

25-week CrUX History trends. Shows whether CWV metrics are improving, stable, or degrading.

**Script:** `python ../../scripts/infrasity-dev-gtm/crux_history.py <url> --json`
**Reference:** `references/pagespeed-crux-api.md`
...
**Script:** `python ../../scripts/infrasity-dev-gtm/gsc_query.py --property <property> --json`
...
**Script:** `python ../../scripts/infrasity-dev-gtm/gsc_inspect.py <url> --json`
...
**Script:** `python ../../scripts/infrasity-dev-gtm/gsc_inspect.py --batch <file> --json`

### `/seo google sitemaps <property>`

List submitted sitemaps with status, errors, warnings.

**Script:** `python ../../scripts/infrasity-dev-gtm/gsc_query.py sitemaps --property <property> --json`
...
**Script:** `python ../../scripts/infrasity-dev-gtm/indexing_notify.py <url> --json`
...
**Script:** `python ../../scripts/infrasity-dev-gtm/indexing_notify.py --batch <file> --json`
...
**Script:** `python ../../scripts/infrasity-dev-gtm/ga4_report.py --property <id> --json`
...
**Script:** `python ../../scripts/infrasity-dev-gtm/ga4_report.py --property <id> --report top-pages --json`
...
**Script:** `python ../../scripts/infrasity-dev-gtm/youtube_search.py search "<query>" --json`
...
**Script:** `python ../../scripts/infrasity-dev-gtm/youtube_search.py video <video_id> --json`
...
**Script:** `python ../../scripts/infrasity-dev-gtm/nlp_analyze.py --url <url> --json` or `--text "..."`
...
**Script:** `python ../../scripts/infrasity-dev-gtm/nlp_analyze.py --url <url> --features entities --json`
...
**Script:** `python ../../scripts/infrasity-dev-gtm/keyword_planner.py ideas "<seed>" --json`
...
**Script:** `python ../../scripts/infrasity-dev-gtm/keyword_planner.py volume "<kw1>,<kw2>" --json`
...
**Script:** `python ../../scripts/infrasity-dev-gtm/google_report.py --type <type> --data <json> --domain <domain> --format pdf`
...
2. Save JSON output to file: `python ../../scripts/infrasity-dev-gtm/pagespeed_check.py <url> --json > data.json`
3. Generate report: `python ../../scripts/infrasity-dev-gtm/google_report.py --type cwv-audit --data data.json --domain <domain>`
