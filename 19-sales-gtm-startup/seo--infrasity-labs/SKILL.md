...
3. If Google API credentials detected (`python ../../scripts/infrasity-dev-gtm/google_auth.py --check`), also spawn seo-google agent
...
6. If backlink APIs detected (`python ../../scripts/infrasity-dev-gtm/backlinks_auth.py --check`), also spawn seo-backlinks agent
...
10. If drift baseline exists for this URL (`python ../../scripts/infrasity-dev-gtm/drift_history.py <url>`), also spawn seo-drift agent
...
strategy. seo-skills uses a 10-principle thinking framework grouped into four
