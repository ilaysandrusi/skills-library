...
The two-tier check treats editorial slop the same way design-slop methodology treats UI: vocabulary-clean is necessary but not sufficient; structural distinctiveness is what separates citeable content from indexable filler.

---

## Attribution

The two-tier first-order / second-order reflex methodology adapts a UI-design cliche-detection model (originally applied to cases like "observability -> dark blue") to prose.
