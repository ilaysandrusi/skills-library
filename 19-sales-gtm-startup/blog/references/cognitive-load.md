...
Adapted from a UI cognitive-load model for editorial use.
...
The three-load model (intrinsic, extraneous, germane) and the four-item working-memory ceiling come from cognitive-load theory (Sweller; Cowan 2001). This reference adapts the framework from UI ergonomics to editorial ergonomics, measuring concepts-per-section.
