...
Adapted from Nielsen's 10 Usability Heuristics. The original framework scores UI; this version scores editorial.
...
Adapts Nielsen's 10 Usability Heuristics (Jakob Nielsen, NN/g, 1994 revised 2020). The 0 to 4 ordinal scale, P0 to P3 severity, and per-dimension tables apply this model to editorial work. The 10 heuristics are translated from UI ergonomics to editorial ergonomics; see the Nielsen-mapping table above.
