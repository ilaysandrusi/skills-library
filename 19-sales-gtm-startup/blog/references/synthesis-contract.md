...
The source methodology defines 8 LAWs; LAW 5 (engine-footer pass-through) and LAW 7 (--plan flag) are runtime-specific concerns and are not ported here.
...
The 6 LAWs above are re-grounded for claude-blog's general blog-research synthesis use case. Two further runtime-specific LAWs from the source methodology are not ported.
