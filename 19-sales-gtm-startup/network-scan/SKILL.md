...
**Fit scoring criteria:** See `references/fit-scoring.md` for the canonical definitions.
...
3. **Next Steps** — suggest tailoring the resume and writing a cover letter for top matches
