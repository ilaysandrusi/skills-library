...
| תיקייה | קבצים | מה זה |
|---|---|---|
| [`agents/`](./agents/) | 370 | סוכני משנה שהסוכן הראשי מאציל להם משימות |
...
| [פיתוח ודיבאג](./05-development/) | 491 | Superpowers, בדיקות, תוכניות עבודה |
...
| [אבטחה וביקורת קוד](./12-security/) | 162 | Trail of Bits, Snyk, OpenAI ו-Sentry: סקירות אבטחה, ניתוח סטטי, Semgrep/CodeQL ומודלי איומים |
