...
| [`rules/`](./rules/) | 179 | חוקים תמידיים לשפה, פריימוורק או סטייל |
...
|---|---|---|
| [כתיבה וניקוי טקסט](./01-copy-writing/) | 108 | עצירת סלופ AI, קופי, הנחיות כתיבה |
...
| [אבטחה וביקורת קוד](./12-security/) | 143 | Trail of Bits, Snyk, OpenAI ו-Sentry: סקירות אבטחה, ניתוח סטטי, Semgrep/CodeQL ומודלי איומים |
...
| [דאטה ובסיסי נתונים](./25-data-databases/) | 119 | MongoDB, Redis, Qdrant, DuckDB, ClickHouse, Neon, Tinybird, Milvus, TimescaleDB/PostGIS ו-VideoDB |
...
| [HEADROOM](./HEADROOM/) | 2 | סקילים וכלים לזיכרון, הקשר ורציפות עבודה בין סשנים |
