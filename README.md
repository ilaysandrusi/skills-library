...
| [`references/`](./references/) | 430 | עצי דוקומנטציה שהסקיל קורא בזמן עבודה |
| [`scripts/`](./scripts/) | 385 | סקריפטים שהסקיל מריץ |
| [`tools/`](./tools/) | 270 | רישומי כלים ומסמכי אינטגרציה |
| [`config/`](./config/) | 15 | קונפיגורציה לדוגמה משותפת |
| [`templates/`](./templates/) | 13 | תבניות מסמכים משותפות |
| [`tasks/`](./tasks/) | 7 | קבצי שלבים ברמת פלאגין |
| [`prompts/`](./prompts/) | 1 | פרומפטים ברמת פלאגין |
